...
select * from isciler;-- tablonun adi degisince bunuda degistik

alter table personel add cinsiyet VARCHAR(20), add yas int;
-- perosnel den sirket fieldi sil 
alter table personel drop column sirket;


--perosnelr deki sehiri ulke olarak degistir

alter table personel rename column sehir to ulke;

--personel tablosunu adini isciler olarak degistir

alter table personel rename to isciler;

--ddl komutlaridan drop 
